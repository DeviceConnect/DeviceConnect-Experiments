...
(h.compile=ea(h.link));h.priority=h.priority||0;h.index=g;h.name=h.name||a;h.require=h.require||h.controller&&h.name;h.restrict=h.restrict||"EA";J(h.scope)&&(h.$$isolateBindings=c(h.scope,h.name));f.push(h)}catch(k){e(k)}});return f}])),d[a].push(e)):r(a,mc(p));return this};this.aHrefSanitizationAllowlist=function(b){return y(b)?(a.aHrefSanitizationAllowlist(b),this):a.aHrefSanitizationAllowlist()};this.imgSrcSanitizationAllowlist=function(b){return y(b)?(a.imgSrcSanitizationAllowlist(b),this):a.imgSrcSanitizationAllowlist()};
