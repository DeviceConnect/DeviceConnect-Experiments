...
public class AdbProtocol {
	...
	// [MODIFIED] デバッグ用関数
	static String parseCmd(final int cmdCode) {
		switch (cmdCode) {
			case CMD_AUTH: return "CMD_AUTH";
			case CMD_CLSE: return "CMD_CLSE";
			case CMD_CNXN: return "CMD_CNXN";
			case CMD_OKAY: return "CMD_OKAY";
			case CMD_OPEN: return "CMD_OPEN";
			case CMD_SYNC: return "CMD_SYNC";
			case CMD_WRTE: return "CMD_WRTE";
			default: return null;
		}
	}
