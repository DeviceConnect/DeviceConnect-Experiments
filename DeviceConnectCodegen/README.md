...
## Get Started
[deviceconnect-codegen-project-1.2.0-dist.zip](https://github.com/TakayukiHoshi1984/DeviceConnect-Experiments/releases/tag/codegen-v1.2.0) をPC上の任意の場所にダウンロードし、解凍してください。
